...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Only the owner can make the call");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != ownerOf(tokenId),
            "'to' address is already owner of this specific token"
        );
        ...
        require(
            ...
            "Access denied, not allowed to call 'approve'"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "'to' param is not a valid address."
        );
...
contract BhattaraiToken is
    ERC721Metadata(
        "Bhattarai RealEstate Token",
        "BRET",
